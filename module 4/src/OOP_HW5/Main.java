...
public class Main{
    public static void main(String[] args) {
        ...
        books[0] = new Book("Мастер и Маргарита", "М.А. Булгаков", "Худ. литература", 1978, 300, "Твердый", 120);
        ...
        books[4] = new Book("Война и мир","Л.Н. Толстой", "Азбука",2018 , 700, "Твердый", 700);
